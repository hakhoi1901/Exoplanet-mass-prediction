...
\begin{longtable}{|p{0.05\textwidth}|p{0.18\textwidth}|>{\linespread{1.3}\selectfont\arraybackslash}p{0.6\textwidth}|p{0.08\textwidth}|}
    ...
    \begin{itemize}[itemsep=0.15cm, topsep=0cm, partopsep=0cm]
        ...
        \item \textbf{Phần 2 (T4):} Sử dụng Pipeline để huấn luyện và đánh giá 4 mô hình (OLS cơ bản, OLS chọn lọc biến, Ridge, Lasso) trên tập dữ liệu thực. Triển khai các bài kiểm định thống kê chuẩn mực (Shapiro-Wilk, Breusch-Pagan).
    \end{itemize} \vspace{-0.2cm} & 
    \centering 100\% \tabularnewline \hline
