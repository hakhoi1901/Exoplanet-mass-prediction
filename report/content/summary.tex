...
\begin{itemize}[itemsep=0.15cm, topsep=0.1cm]
    ...
    \item \textbf{Thử nghiệm kỹ thuật nâng cao có kiểm soát phạm vi:} Kernel Ridge Regression
          với RBF kernel được triển khai như phần mở rộng. Do chi phí ma trận Gram tăng nhanh,
          thử nghiệm chỉ dùng tối đa 200 mẫu train; vì vậy kết quả Kernel Ridge được diễn giải
          như một kiểm chứng bổ sung, không phải kết luận tổng quát rằng phương pháp kernel kém
          hơn OLS/Ridge/Lasso trên toàn bộ bài toán.
\end{itemize}
